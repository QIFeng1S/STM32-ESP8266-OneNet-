...
// 第1步：配置参数（请修改为你自己的）
// =====================================================
#define WIFI_SSID       "xxx"           // 你的WiFi名称
#define WIFI_PASSWORD   "xxx"           // 你的WiFi密码

// 固定明文域名：mqtts.heclouds.com:1883（不启用TLS）
#define ONENET_SERVER   "mqtts.heclouds.com"
#define ONENET_PORT     1883

#define PRODUCT_ID      "xxx"        // 产品ID（控制台可见）
#define DEVICE_NAME     "xxx"        // 设备名（创建设备的名称）
#define API_KEY         "xxx"        // 使用登录令牌(token)
// =====================================================
